...
export default {
  ...
  data() {
    return {
      ...
      userName: "",
      password: "",
      regX: /^[a-zA-Z]+@finastra.com$/,
      value: "",
      result: "",
      users: [
        { email: "uma@finastra.com", password: "123456" },
        { email: "kiran@finastra.com", password: "123456" },
        { email: "shiva@finastra.com", password: "123456" },
      ],

      userValidation: [
        (value) => !!value || "Required.",
        (value) => value && console.log(this.userName, this.regX),
        (value) => (value && this.regX.test(this.userName)) || "Please enter your Organisation email",
      ],
